$(function () {
  ...
  var res = [
    './res/bg.mp3?v=2.0',
    './images/answer_bg.png?v=2.0',
    './images/bg.jpg?v=2.0',
    './images/bg2.jpg?v=2.0',
    './images/button.png?v=2.0',
    './images/clock.png?v=2.0',
    './images/error.png?v=2.0',
    './images/light.png?v=2.0',
    './images/logo.png?v=2.0',
    './images/music.png?v=2.0',
    './images/page1_text_front.png?v=2.0',
    './images/page1_text1.png?v=2.0',
    './images/page1_text2.png?v=2.0',
    './images/page1_text3.png?v=2.0',
    './images/page1_text4.png?v=2.1',
    './images/page1-img.png?v=2.0',
    './images/page2_text1.png?v=2.0',
    './images/page2_text2.png?v=2.0',
    './images/page3_btn.png?v=2.0',
    './images/page3_text1.png?v=2.0',
    './images/page3_text2.png?v=2.0',
    './images/page3_text3.png?v=2.0',
    './images/page6_text1.png?v=2.0',
    './images/page6_text2.png?v=2.0',
    './images/sign_bg.png?v=2.0',
    './images/success.png?v=2.0',
    './images/tips-success.png',
    './images/tips-success1.png',
    './images/tips-success2.png',
    './images/tips-success3.png',
    './images/tips-success4.png',
    './images/tips-error1.png',
    './images/tips-error2.png',
    './images/tips-error3.png'
  ]; // 这是添加预加载内容
  loader.startLoad(res).handlerLoadComplete(function () {
    ...
    $('.sign-btn').on('click', function () {
      ...
      $.ajax({
        url: 'http://wx.gz.focus.cn/api/BmInfo',
        type: 'post',
        data: {
          gid: 74,
  ...
  window.mywx && mywx.setData({
    title: '考验你智商的时候到了！',
    desc: '5万元的教育基金等你来拿！',
    link: 'http://wx.gz.focus.cn/html/baoli_brain/',
